...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GalleryFotolist = (ArrayList<GalleryFoto>) getArguments().getSerializable("GalleryFotolist");
        selectedPosition = getArguments().getInt("position");

        Log.e(TAG, "position: " + selectedPosition);
        Log.e(TAG, "images size: " + GalleryFotolist.size());
...
//
//                final GalleryFoto image = GalleryFotolist.get(selectedPosition);
//                final String fullUrl = "http://appro.probolinggokab.go.id/adminhumas/pict/" + image.nama_file;
//
//                String url = fullUrl;
//                //NOTE
//                mProgressDialog = new ProgressDialog(getContext());
//                mProgressDialog.setMessage("Sedang mengunduh file...");
...
//        });
    ...
    private void displayMetaInfo(int position) {
        lblCount.setText((position + 1) + " of " + GalleryFotolist.size());

        final GalleryFoto image = GalleryFotolist.get(position);
        lblTitle.setText(image.getNama_foto());
        setImgLink = image.getNama_foto().toString();
        lblDate.setText("Tanggal : 18 Agustus 2018 (Contoh)");
